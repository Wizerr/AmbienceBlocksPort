...
public class RenderTypeHelper extends RenderStateShard {
    ...
    public static final ShaderStateShard RENDERTYPE_LINES_NO_DEPTH_SHADER = new ShaderStateShard(RenderTypeHelper::getRendertypeLinesNoDepthShader);
    ...
    public static final RenderType LINES_NO_DEPTH = RenderType.create(
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setLineState(new RenderStateShard.LineStateShard(OptionalDouble.of(2.0D))) // épaisseur
                    .setLayeringState(RenderStateShard.VIEW_OFFSET_Z_LAYERING)
                    .setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY)
                    .setWriteMaskState(RenderStateShard.COLOR_DEPTH_WRITE)
                    .setCullState(RenderStateShard.NO_CULL)
                    .setDepthTestState(RenderStateShard.NO_DEPTH_TEST) // <<< magique
    ...
    public static void registerShadersEvent(RegisterShadersEvent event) {
        try {
            event.registerShader(new ShaderInstance(event.getResourceProvider(), new ResourceLocation(Main.MODID, "rendertype_lines_nodepth"), DefaultVertexFormat.POSITION_COLOR_NORMAL), (lol) -> {
