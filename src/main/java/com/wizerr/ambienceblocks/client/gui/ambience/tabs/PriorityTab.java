...
public class PriorityTab extends AbstractTab {
    ...
    public EditBox priority = new EditBox(font, getNeighbourX(textPriority), getRowY(0), 40, 20, Component.empty());
    ...
    public EditBox channel = new EditBox(font, getNeighbourX(textChannel), getRowY(0), 20, 20, Component.empty());
    ...
    public void updateWidgetPosition() {
        textPriority.setPosition(getBaseX(), getRowY(0) + getOffsetFontY());
        priority.setPosition(getNeighbourX(textPriority), getRowY(0));
        textChannel.setPosition(getNeighbourX(priority), getRowY(0) + getOffsetFontY());
        channel.setPosition(getNeighbourX(textChannel), getRowY(0));
        allowSamePriority.setPosition(getBaseX(), getRowY(1));
    }
